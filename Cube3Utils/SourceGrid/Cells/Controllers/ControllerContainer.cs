...
namespace SourceGrid.Cells.Controllers
{
	public class ControllerContainer : IController
	{
		...
		public void OnMouseDown(CellContext sender, Eto.Forms.MouseEventArgs e)
		{
			foreach (IController controller in m_ControllerList)
				controller.OnMouseDown(sender, e);
		}

		public void OnMouseUp(CellContext sender, Eto.Forms.MouseEventArgs e)
		{
			foreach (IController controller in m_ControllerList)
				controller.OnMouseUp(sender, e);
		}

		public void OnMouseMove(CellContext sender, Eto.Forms.MouseEventArgs e)
		{
			foreach (IController controller in m_ControllerList)
		...
		public void OnKeyUp(CellContext sender, Eto.Forms.KeyEventArgs e)
		{
			foreach (IController controller in m_ControllerList)
				controller.OnKeyUp(sender, e);
		}

		public void OnKeyDown(CellContext sender, Eto.Forms.KeyEventArgs e)
		{
			foreach (IController controller in m_ControllerList)
				controller.OnKeyDown(sender, e);
		}

		public void OnKeyPress(CellContext sender, Eto.Forms.KeyEventArgs e)
		{
			foreach (IController controller in m_ControllerList)
		...
		public void OnDragDrop(CellContext sender, Eto.Forms.DragEventArgs e)
		{
			foreach (IController controller in m_ControllerList)
				controller.OnDragDrop(sender, e);
		}

		public void OnDragEnter(CellContext sender, Eto.Forms.DragEventArgs e)
		{
			foreach (IController controller in m_ControllerList)
		...
		public void OnDragOver(CellContext sender, Eto.Forms.DragEventArgs e)
		{
			foreach (IController controller in m_ControllerList)
				controller.OnDragOver(sender, e);
		}

		public void OnGiveFeedback(CellContext sender, EventArgs e)
		{
			foreach (IController controller in m_ControllerList)
