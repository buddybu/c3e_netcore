...
namespace SourceGrid.Cells.Controllers
{
	...
	{
		public readonly static MouseCursor Default = new MouseCursor(Eto.Forms.Cursors.Default, true);
		public readonly static MouseCursor Hand = new MouseCursor(Eto.Forms.Cursors.Pointer, true);

		#region Constructor
		public MouseCursor(Eto.Forms.Cursor cursor, bool applyOnMouseEnter)
		{
		...
		private Eto.Forms.Cursor mCursor = null;

		public Eto.Forms.Cursor Cursor
		{
			get{return mCursor;}
			set{mCursor = value;}
		}
